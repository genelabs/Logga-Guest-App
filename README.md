...
- ✨ Added photo capture for visitors
- ✨ Added live occupancy dashboard
- ✨ Added issue reporting system
- ✨ Added global search functionality
- 🎨 Enhanced statistics view with tabs
- 🐛 Improved data persistence with photo support

### Version 1.0.0
- 🎉 Initial release
- Staff check-in/out functionality
- Visitor management with pass numbers
- Basic statistics and records
...
For support, please open an issue on GitHub or contact ekagbo@outlook.com.
